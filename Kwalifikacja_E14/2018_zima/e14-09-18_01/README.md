# 📌 2018_zima - e14-09-18_01 (E.14 (Tworzenie aplikacji internetowych i baz danych))
...
- 📄 **Arkusz PDF:** `E.14-09-18.01.pdf`
- 🌐 **Pliki HTML:** `www/index.html`
- 💾 **Baza / Kwerendy SQL:** `baza/szkola.sql`, `baza/szkola_nowa.sql`
- 📝 **Pliki tekstowe / Kwerendy:** `baza/zapytania.txt`
...
2. **Import bazy danych:**
   ...
   - Utwórz nową bazę danych i zaimportuj plik SQL (`szkola.sql`, `szkola_nowa.sql`).
