# 📌 2018_zima - e14-08-18_01 (E.14 (Tworzenie aplikacji internetowych i baz danych))

> **Temat zadania:** Baza Danych Uczniów i Ocen  
...
Relacyjna baza danych szkoły z kwerendami SQL obliczającymi średnie ocen, filtrującymi klasy i przedmioty.
...
- 📄 **Arkusz PDF:** `E.14-08-18.01.pdf`
- 🌐 **Pliki HTML:** `www/index.html`
- 💾 **Baza / Kwerendy SQL:** `baza/szkola_nowa.sql`, `szkola.sql`
- 📝 **Pliki tekstowe / Kwerendy:** `baza/kwerendy.txt`, `baza/zapytania.txt`
- 🎨 **Style CSS:** `www/styl.css`
...
2. **Import bazy danych:**
   ...
   - Utwórz nową bazę danych i zaimportuj plik SQL (`szkola_nowa.sql`, `szkola.sql`).
