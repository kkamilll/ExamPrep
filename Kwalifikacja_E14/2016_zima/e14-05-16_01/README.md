# 📌 2016_zima - e14-05-16_01 (E.14 (Tworzenie aplikacji internetowych i baz danych))

> **Temat zadania:** 2016 zima   e14 05 16 01  
...
- 📄 **Arkusz PDF:** `E.14-05-16.01.pdf`
- 🌐 **Pliki HTML:** `index.html`
- 💾 **Baza / Kwerendy SQL:** `baza/baza_zad5.sql`, `baza/meteo.sql`
...
2. **Import bazy danych:**
   ...
   - Utwórz nową bazę danych i zaimportuj plik SQL (`baza_zad5.sql`, `meteo.sql`).
